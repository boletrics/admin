    ...
    <header className="sticky top-0 z-50 flex h-16 shrink-0 items-center gap-2 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4">
      ...
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <Input type="text" placeholder="Buscar eventos, órdenes..." className="pl-9 h-9" />
        </div>
      </div>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem className="flex flex-col items-start gap-1">
              ...
              <p className="text-sm text-muted-foreground">Se vendieron 5 boletos para Bad Bunny World Tour</p>
              <p className="text-xs text-muted-foreground">Hace 5 minutos</p>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1">
              <p className="font-medium">Solicitud de reembolso</p>
              <p className="text-sm text-muted-foreground">Orden #12345 solicita reembolso</p>
              <p className="text-xs text-muted-foreground">Hace 1 hora</p>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1">
              <p className="font-medium">Evento casi agotado</p>
              <p className="text-sm text-muted-foreground">Coldplay tiene 95% de ocupación</p>
