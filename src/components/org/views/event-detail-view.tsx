...
export function EventDetailView({ eventId }: EventDetailViewProps) {
	...
	// Fetch organizations to display org name
				...
				<Card>
					<CardContent className="py-12 text-center">
						...
						<Button asChild className="mt-4">
							<Link href="/org/events">Volver a eventos</Link>
						</Button>
					</CardContent>
				</Card>
			</div>
			...
			<div className="flex items-start justify-between">
				...
				<div className="flex items-center gap-2">
					...
					<Button variant="outline" asChild>
						<Link href={`/org/events/${eventId}/edit`}>
			...
			<div className="grid gap-6 lg:grid-cols-3">
				...
				<div className="lg:col-span-2 space-y-6">
					...
					<Card>
						...
						<CardContent>
							<p className="font-medium">{getOrgName(event.org_id)}</p>
					...
					<Card>
						...
						<CardContent className="space-y-2">
							<Button
								...
								asChild
							>
								<Link href={`/org/events/${eventId}/orders`}>
							...
							<Button
								...
								asChild
							>
								<Link href={`/org/scan?eventId=${eventId}`}>
