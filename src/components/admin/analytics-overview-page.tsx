...
import { Users, Building2, DollarSign, TicketCheck, ArrowUpRight, ArrowDownRight } from "lucide-react"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { mockPlatformStats, mockRevenueTimeline, mockGrowthMetrics } from "@/lib/admin-mock-data"
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatNumber(stats.activeTenants)}</div>
            <p className="text-xs text-emerald-600 flex items-center gap-1 mt-1">
              <ArrowUpRight className="h-3 w-3" />
              +5.2% from last month
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-emerald-600">{stats.uptime}%</span>
            </div>
            <div className="flex items-center justify-between">
