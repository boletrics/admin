  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Configure platform settings and administrative controls</p>
      </div>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="supportEmail" type="email" defaultValue="support@boletrics.com" />
                </div>
                <div className="space-y-2">
                  ...
                  <Select defaultValue="america-mexico">
                    ...
                    <SelectContent>
                      <SelectItem value="america-mexico">America/Mexico_City</SelectItem>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Automatically approve new tenant registrations without manual review
                  </p>
                </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Receive immediate alerts for critical issues (system down, security breaches)
                  </p>
                </div>
              ...
              <div className="space-y-2">
                ...
                <Input type="url" placeholder="https://hooks.slack.com/services/..." disabled={!slackNotifications} />
              </div>
            </CardContent>
          </Card>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground font-mono">sk_admin_****...****8f2d</p>
                    </div>
                  </div>
        ...
        <TabsContent value="maintenance" className="space-y-6">
          <Card className={maintenanceMode ? "border-amber-500/50 bg-amber-500/5" : ""}>
            <CardHeader>
              ...
              <CardDescription>
                Enable maintenance mode to temporarily disable platform access for users
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Clear all cached data from Redis</p>
                </div>
