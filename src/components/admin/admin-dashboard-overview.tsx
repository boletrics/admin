			...
			<CardHeader>
				<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
					<div className="min-w-0">
						...
						<CardDescription>
							{openTickets.length} tickets require attention
						</CardDescription>
					</div>
					<Button
						variant="outline"
						size="sm"
						className="shrink-0 w-fit bg-transparent"
					>
						View All
					</Button>
				</div>
			...
			<CardContent>
				<div className="space-y-4">
					{openTickets.slice(0, 4).map((ticket) => (
						...
						>
							<span
								className={`h-2 w-2 rounded-full mt-2 shrink-0 ${priorityColors[ticket.priority]}`}
							/>
		...
		<div className="p-4 sm:p-6 space-y-6 overflow-hidden">
			<div>
				...
				<p className="text-muted-foreground">
					Monitor platform health, manage tenants, and handle support tickets
				</p>
			</div>
