...
function AuthContent() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Authentication API not implemented",
      })
    } catch (error) {
      toast({
        variant: "destructive",
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: t("common.error"),
        description: "Registration API not implemented",
      })
    } catch (error) {
      toast({
        variant: "destructive",
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      //   method: "POST",
      //   headers: { "Content-Type": "application/json" },
      //   body: JSON.stringify({ email: otpEmail, code: otpCode, mode: otpMode }),
      // })
      // const user = await response.json()
      // setUser(user)
      ...
      toast({
        variant: "destructive",
        title: t("common.error"),
        description: "OTP verification API not implemented",
      })
    } catch (error) {
      toast({
        variant: "destructive",
