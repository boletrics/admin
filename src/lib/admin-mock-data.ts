...
export type { Tenant, SupportTicket } from "./admin-store";
...
export const mockSystemHealth: SystemHealth = {
	...
	services: [
		...
		},
		{
			...
			status: "degraded",
			latency: 450,
			lastIncident: "2025-01-12T08:00:00Z",
		},
		{
			id: "storage",
			name: "Object Storage",
...
export const mockSupportTickets: SupportTicket[] = [
	{
		...
		description:
			"Users are experiencing timeout errors when trying to complete purchases with credit cards.",
		status: "in-progress",
		priority: "critical",
		category: "technical",
		tenantId: "tenant-1",
		...
		messages: [
			{
				id: "msg-1",
				content:
					"We are seeing multiple payment failures in our dashboard. This started around 8:00 AM.",
			...
			},
			{
				id: "msg-2",
				content:
					"We've identified the issue with our payment gateway. Working on a fix now. ETA: 30 minutes.",
				authorId: "admin-3",
	...
	},
	{
		...
		description:
			"When I try to access the billing settings, the page shows a blank screen.",
		status: "open",
		priority: "high",
		category: "billing",
		tenantId: "tenant-3",
		...
		messages: [
			{
				id: "msg-3",
				content:
					"We want to upgrade to Enterprise plan but cannot access billing. Please help urgently.",
		...
		messages: [
			{
				id: "msg-4",
				content:
					"We need our API rate limits increased from 1000 to 5000 requests per minute.",
	...
	},
	{
		...
		description:
			"We purchased the professional plan and want to configure our custom domain for ticket pages.",
		status: "resolved",
		priority: "low",
		category: "account",
		tenantId: "tenant-4",
	...
	},
	{
		...
		description:
			"Our account was suspended but we believe this was in error. We need immediate reinstatement.",
		status: "open",
		priority: "high",
		category: "account",
		tenantId: "tenant-7",
